...
class StaticModel():
    ...
    def _init_hyper_parameters(self):
        ...
        self.interacting_layers = self.config.get(
            "hyper_parameters.interacting_layers")
    ...
    def net(self, input, is_infer=False):
        ...
        autoint_model = AutoIntLayer(self.sparse_feature_number,
                                     self.sparse_feature_dim,
                                     self.dense_input_dim, sparse_number,
                                     self.num_heads, self.interacting_layers)

        pred = autoint_model.forward(self.sparse_inputs, self.dense_input)
